...
public class Constantes {
	...
	public static String ANTE_HEADER = 
	...
	public static String INFLACIONSS_GRAFICA_TITULO =
				"Índice de Inflación del Sector Salud";
	
	public static String ANTE_TITULO = "Antecedentes";
	
	public static String INFLACIONSS_TITULO =
				"Inflación del Sector Salud";
	
	public static String PERCAPITA_TITULO =
					"Indicadores de siniestralidad";
	
	public static String SIN_ESPERADA_TITULO =
	...
	public static String COSTO_PROMEDIO_SIN_TITULO =
			"Costo Promedio de Siniestro";
